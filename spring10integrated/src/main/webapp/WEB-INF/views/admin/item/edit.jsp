...
<form action ="edit" method ="post" enctype="multipart/form-data">
	...
	상품명 <input type="text" name="itemName" value="${itemDto.itemName}">
	판매가 <input type="number"  name="itemPrice" value="${itemDto.itemPrice}">
	충전액 <input type="number" name="itemCharge" value="${itemDto.itemCharge}">
