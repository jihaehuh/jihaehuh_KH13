...
<h2>로그인 상태 : ${sessionScope.loginId != null}</h2>
<h2>아이디 : ${sessionScope.loginId}, 등급 : ${sessionScope.loginLevel}</h2>
...
$(function(){
	//시작하자마자 웹소켓 서버에 연결
	window.socket = new SockJS("${pageContext.request.contextPath}/ws/member");
