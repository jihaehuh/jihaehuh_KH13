...
//	-등록을 @ControllerAdvice 로 하면, 옵션으로 대상을 반드시 지정해야한다
//	-클래스 내에는 @ExceptionHandler 를 만들어 예외를 종류별로 처리
...
@ControllerAdvice(annotations = {Controller.class})  //컨트롤러 붙어있는모든 애들 간섭할게
public class ErrorController {
	...
	public String Handler(Exception e) {
		...
		e.printStackTrace();
		return "/WEB-INF/views/error.jsp";//에러페이지주소
	}
}
