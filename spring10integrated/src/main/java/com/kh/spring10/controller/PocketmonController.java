...
public class PocketmonController {
	...
	public String insert1() {
		return "/WEB-INF/views/pocketmon/insert1.jsp";   //"포켓몬스터 정보 입력 페이지 주소";
	}
	...
	public String insert3() {
		return "/WEB-INF/views/pocketmon/insert3.jsp";  //새로고침 눌렀을때 실행되는 주소
	}
	//수정페이지
		//- 등록과 매우 유사한 흐름을 가진다
		//- 입력된 정보중 기본키를 제외한 나머지 정보를 수정한다
