package com.kh.spring04paramete.controller;
...
public class ParameterController {
	...
	//(Q) 출생년도 8자리를 입력하면 한국 나이를 반환
		...
		//파라미터를 받기 위한 고급설정이 가능하다
		//-price 가 없을 경우 0으로 대체
		//- people이 없을 경우 1로 대체
		//-파라미터에 @RequestParam등록을 해야함
